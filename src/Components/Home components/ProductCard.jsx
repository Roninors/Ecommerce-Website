    ...
    return(
        <div className=" flex justify-between items-center flex-col gap-5  ">
          ...
          <div className=" relative flex   h-[35vh] w-[35vh]  group">
            ...
            <p className=" absolute bottom-0 left-0  p-[1em] rounded-full hidden lg:group-hover:block text-center font-pop text-sm hover:underline m-2  text-white cursor-pointer z-10">Add to cart</p>
