...
function Home(){
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const responseClassy = await fetch("https://ecommerce-website-gvr1ww2rs-roninors.vercel.app/products/collections", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ "productCollection": "classics" })
            });
      
            const responseBreathable = await fetch("https://ecommerce-website-gvr1ww2rs-roninors.vercel.app/products/collections", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
